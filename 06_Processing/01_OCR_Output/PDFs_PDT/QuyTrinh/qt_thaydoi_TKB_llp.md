...
```mermaid
graph TD
    Step1([Đề nghị thay đổi TKB]) --> Step2{GV xem xét}
    Step2 -- Đồng ý --> Step3{Kiểm tra}
    Step2 -- Không đồng ý --> Step5([Thông báo kết quả])
    Step3 -- Đạt --> Step4[Điều chỉnh TKB]
    Step3 -- Không đạt --> Step5
    Step4 --> Step5
```
